...
- **N4 下载：N4a–N4e 已完成，下一步 N4f 收藏夹/合集批量**（子计划 `docs/plans/2026-08-23-phase-b-mobile-n4f.md`，**v1 待评审、决策 a–h 待关闭**，两批 N4f-1/2、只上机一次）（全期子计划 `docs/plans/2026-08-20-phase-b-mobile-n4.md` v2，七批 N4a–N4g / 判据 40 条）。用户 2026-08-20 拍板四条范围：**TLS 移出 N4**（不阻塞 N4 任何子批，**硬阻塞 N5**——主计划 §4.3 有 Stage-3 修订）· **LLM 设置页进 N4** · **收藏夹/合集批量进 N4** · **加 dataSync 前台服务**。
